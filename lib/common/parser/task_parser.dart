...
class TaskParser {
  ...
  static const Color mentionColor =
      Color(0xFF3B82F6); // AppColors.taskMarker (Deep Blue)
  static const Color goalColor =
      Color(0xFF06B6D4); // AppColors.goalTaskMarker (Cyan)
