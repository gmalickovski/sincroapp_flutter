...
class TaskParser {
  ...
  static const Color goalColor = Colors.orangeAccent;
  ...
  static ParserTrigger? detectActiveTrigger(String text, int cursorPos) {
    ...
    // Procura o último trigger antes do cursor
    for (final trigger in ['@', '#', '!']) {
      ...
      // Verifica se não contém espaço (espaço termina o trigger)
  ...
  static String toText(TaskModel task) {
    ...
    if (task.dueDate != null) {
      ...
      if (dt.year == now.year) {
        sb.write(' /${dt.day.toString().padLeft(2, '0')}/${dt.month.toString().padLeft(2, '0')}');
      } else {
        sb.write(' /${dt.day.toString().padLeft(2, '0')}/${dt.month.toString().padLeft(2, '0')}/${dt.year}');
      }
