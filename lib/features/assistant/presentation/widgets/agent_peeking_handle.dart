...
class _AgentPeekingHandleState extends State<AgentPeekingHandle>
...
class _UnifiedHandlePainter extends CustomPainter {
  ...
  void _drawFace(Canvas canvas, double cx, double cy, double radius) {
    ...
    if (blinkProgress > 0.1) {
      ...
      winkPath.quadraticBezierTo(rightEyePos.dx, rightEyePos.dy + 3,
          rightEyePos.dx + 3, rightEyePos.dy);
    ...
    */
    ...
    path.quadraticBezierTo(
        cx + eyeOffsetX, cy + 8, cx + eyeOffsetX + 4, cy + 6);
