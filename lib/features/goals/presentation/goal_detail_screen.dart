                            ...
                            return SafeArea(
                              child: Column(
                                children: [
                                  ...
                                  // ─── BOTTOM SECTION: Toolbar and List ───
                                  Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      // Title row with goal name + Criar Marco button
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            TextButton.icon(
                              onPressed: () => _showDesktopMilestoneModal(currentGoal),
                              icon: const Icon(Icons.add_circle_outline, size: 18),
                              label: const Text('Criar Marco'),
                              style: TextButton.styleFrom(
                                foregroundColor: AppColors.primaryText,
