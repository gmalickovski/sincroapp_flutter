  ...
  Future<void> _submit() async {
    if (_descriptionController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Por favor, descreva o problema ou ideia.')),
      );
      return;
    }
  ...
  List<DropdownMenuItem<FeedbackType>> get _dropdownItems {
    ...
    return const [
      DropdownMenuItem(
          ...
          child: Row(children: [
            Icon(Icons.bug_report, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Bug', style: style)
          ])),
      DropdownMenuItem(
          value: FeedbackType.idea,
          child: Row(children: [
            Icon(Icons.lightbulb, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Sugestão', style: style)
          ])),
      DropdownMenuItem(
          value: FeedbackType.general,
          child: Row(children: [
            Icon(Icons.rocket_launch, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Primeiros Passos', style: style)
          ])),
      DropdownMenuItem(
          value: FeedbackType.account,
          child: Row(children: [
            Icon(Icons.shield, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Conta e Segurança', style: style)
          ])),
      DropdownMenuItem(
          value: FeedbackType.subscription,
          child: Row(children: [
            Icon(Icons.diamond, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Assinatura e Planos', style: style)
          ])),
      DropdownMenuItem(
          value: FeedbackType.tech,
          child: Row(children: [
            Icon(Icons.build, color: AppColors.secondaryText),
            SizedBox(width: 8),
            Text('Solução de Problemas', style: style)
          ])),
    ];
  }
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            'Como podemos ajudar? Descreva sua dúvida ou problema...',
                        hintStyle:
                            const TextStyle(color: AppColors.tertiaryText),
                        filled: true,
                  ...
                  _attachment == null
                      ? OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.attach_file,
                              color: AppColors.secondaryText),
                          label: const Text('Anexar Captura de Tela',
          ...
          children: [
            ...
            _attachment == null
                ? OutlinedButton.icon(
                    ...
                    label: const Text('Anexar Print (Opcional)',
